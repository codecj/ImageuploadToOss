<template> <div id="settledCommission"> <ul> <li> <div class="header"> <h3>好又多超市</h3> </div> <div class="content"> <img src="" alt="" class="goodsImg"> <h4 class="goodsName">墨西哥辣鸡点心面两行位置啊啊啊啊啊</h4> <span class="specification">规格：3434*33</span> <span class="price">￥200.00</span> <span class="praise">奖</span> <span class="praisePrice">￥8.00</span> <span class="goodsCount">x3</span> </div> <div class="footer"> <span class="commissionTime">结算时间 2017.4.11 16：30</span> <span class="praise">奖</span> <span class="commissionPrice">￥24.00</span> </div> </li> </ul> </div> </template> <script type="text/javascript"> import Request from "../util/API";
import Vue from 'vue';
import {
    Toast,
    Indicator
